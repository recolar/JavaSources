...
public class MD5Code {
	...
	public static void main(String[] args) throws Exception {
		...
		final String name = "钓鱼岛是中国的";
		String md5Str = md.getMD5ofStr(name);
		System.out.println(String.format("Before:%s\r\nAfter:%s", new Object[] { name, md5Str }));
		System.out.println(md5Str.length());

		String afterZip = SysUtil.zipAndEncodeString(name);
		System.out.println(String.format("Before:%s\r\nAfter:%s", new Object[] { name, afterZip }));
		System.out.println(afterZip.length());
		System.out.println(SysUtil.unzipAndDecodeString(afterZip));
	}
}
